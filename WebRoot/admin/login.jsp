...
%>
<body background="<%=basePath %>images/bg.jpg" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
          ...
          <td> 
            ...
            <table width="260" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr> 
                ...
                <td width="86" class="font1" height="36"><font color="black">用 户 名</font></td>
