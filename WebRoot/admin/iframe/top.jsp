...
<TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#123456 border=0>
  <TBODY>
  <TR>
    <TD height=25>
...
<TABLE class=HeaderStyle bgColor=#123456 height=30 cellSpacing=0 cellPadding=0 width="100%" border=0>
  <TBODY>
  <TR>
    <TD width=14  >&nbsp;</TD>
    <TD align=center><h2>后台管理系统</h2>
       </TD>    
</TR></TBODY></TABLE>
